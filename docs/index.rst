...
This model includes full re-calibration of the SALT3 training data (`Brout et al., 2021 <https://arxiv.org/abs/2112.03864>`_) to match SALT training sets used in the `Pantheon+ analysis <https://ui.adsabs.harvard.edu/abs/2022ApJ...938..113S/abstract>`_.  Other SALT3 publications include:
...
- `Kenworthy et al., 2021, ApJ, 923, 265K <https://ui.adsabs.harvard.edu/abs/2021ApJ...923..265K/abstract>`_: SALT3 model and SALTShaker framework.
...
- `Dai et al., 2023, ApJ, in press <https://ui.adsabs.harvard.edu/abs/2022arXiv221206879D/abstract>`_: SALT3 model validation with extensive simulations and full training pipeline.
