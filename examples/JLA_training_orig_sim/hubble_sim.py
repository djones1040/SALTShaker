...
def concatfitres_large():
    #frfiles = np.array(['simfit_large/JLA_TRAINING_Hicken09_LARGE_G10.FITRES.TEXT',
    #                    'simfit_large/JLA_TRAINING_SDSS_LARGE_G10.FITRES.TEXT',
    #                    'simfit_large/JLA_TRAINING_SNLS3_LARGE_G10.FITRES.TEXT',
    #                    'simfit_large/JLA_TRAINING_Hicken09_LARGE_G10_SALT2.FITRES.TEXT',
    #                    'simfit_large/JLA_TRAINING_SDSS_LARGE_G10_SALT2.FITRES.TEXT',
    #                    'simfit_large/JLA_TRAINING_SNLS3_LARGE_G10_SALT2.FITRES.TEXT'])
    frfiles = np.array(['simfit_large/JLA_TRAINING_Hicken09_LARGE.FITRES.TEXT',
                        'simfit_large/JLA_TRAINING_SDSS_LARGE.FITRES.TEXT',
                        'simfit_large/JLA_TRAINING_SNLS3_LARGE.FITRES.TEXT',
                        'simfit_large/JLA_TRAINING_Hicken09_LARGE_SALT2.FITRES.TEXT',
                        'simfit_large/JLA_TRAINING_SDSS_LARGE_SALT2.FITRES.TEXT',
                        'simfit_large/JLA_TRAINING_SNLS3_LARGE_SALT2.FITRES.TEXT'])

    count2,count3 = 0,0
    with open('JLA_TRAINING_SALT2_LARGE.FITRES','w') as fout2,open('JLA_TRAINING_SALT3_LARGE.FITRES','w') as fout3:
        for f in frfiles:
            if 'SALT2' not in f:
                with open(f) as fin:
                    for line in fin:
...
def run_salt2mu_large():
    # run SALT2mu
    os.system('SALT2mu.exe SALT2mu.default file=JLA_TRAINING_SALT2_LARGE.FITRES prefix=SALT2mu_SALT2_LARGE')
    os.system('SALT2mu.exe SALT2mu.default file=JLA_TRAINING_SALT3_LARGE.FITRES prefix=SALT2mu_SALT3_LARGE')    
...
def main():
    ...
    #ax1.set_title('Simulated SALT2 Training Data',fontsize=15)
...
$med. \chi^2_{{\nu}}$ = {med_chi3:.2f}""",
    ...
    ax2.text(0.03,0.97,f"""SALT2 RMS = {np.std(fr2.mures):.3f}""",transform=ax2.transAxes,ha='left',va='top',color='b')
    ax2.text(0.03,0.92,f"""SALT3 RMS = {np.std(fr3.mures):.3f}""",transform=ax2.transAxes,ha='left',va='top',color='r')
