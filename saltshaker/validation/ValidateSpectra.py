...
def compareSpectra(speclist,salt3dir,outdir=None,specfile=None,parfile='salt3_parameters.dat',
    ...
    for sn in datadict.keys():
        ...
        snPars={'z':datadict[sn].zHelio,'t0':datadict[sn].tpk_guess}
...
#           continue
        ...
        for k in specdata.keys():
            ...
            uncalledModel = flux(salt3dir,specdata[k].tobs,specdata[k].wavelength,
                                  snPars['z'],snPars['x0'],snPars['x1'],snPars['c0'],mwebv=datadict[sn].MWEBV)
