...
def jaxoptions(fun,static_argnums=None,static_argnames=None,jac_argnums=[0], jitdefault=False):
    ...
    def wrapped(*args,jit=jitdefault,jac=False,forward=False,**kwargs):
