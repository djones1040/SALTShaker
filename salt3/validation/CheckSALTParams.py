...
# 			if os.path.exists(l.replace('_HEAD.FITS','_SPEC.FITS')):
# 				specfitsfile = l.replace('_HEAD.FITS','_SPEC.FITS')
...
# 				print(sn.SNID,sn.SIM_SALT2x0)
# 				print(parameters[parlist == 'x0_%s'%sn.SNID])
# 				print(sn.REDSHIFT_FINAL)
